      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">{installers.length} registered · {installers.filter(i => i.status === 'active').length} active</p>
          </div>
        </div>
                ...
                {installers.map((inst: any) => (
                  ...
                  >
                    <td className="px-5 py-3">
                      ...
                      <div className="text-xs text-gray-400">{inst.users?.email}</div>
                    </td>
            ...
            {selected ? (
              <div className="bg-white border border-gray-200 rounded-xl p-5 space-y-4">
                <div>
                  ...
                  <div className="text-xs text-gray-400 mt-0.5">{selected.users?.email}</div>
                </div>
                ...
                <div className="space-y-2 text-xs border-t border-gray-100 pt-4">
                  {[
                    ...
                    { label: 'Registered', value: selected.users?.created_at ? new Date(selected.users.created_at).toLocaleDateString('en-GB') : '—' },
                  ].map(row => (
